...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2017 a las 01:40:05
...
INSERT INTO `canvas` (`canvasId`, `tw`, `th`, `width`, `height`, `descripcion`) VALUES
(28, 64, 64, 13, 10, 'Big'),
(29, 64, 64, 9, 6, 'Medium'),
(30, 64, 64, 4, 4, 'Small');
...
('Terreno', 'img/tilesets/terrain.png', 'terrain', 256, 192, 0, 41, 11),
('Naturaleza', 'img/tilesets/nature.png', 'nature', 256, 192, 0, 42, 11),
('Caminos', 'img/tilesets/roads.png', 'directions', 512, 256, 2, 43, 11),
('Edificios', 'img/tilesets/buildings.png', 'store', 256, 192, 0, 44, 11);
...
ALTER TABLE `tiles`
  ...
  ADD KEY `tileCategoria` (`idCategoria`),
...
--
ALTER TABLE `canvas`
  MODIFY `canvasId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT de la tabla `categorias`
--
ALTER TABLE `categorias`
  MODIFY `categoriaId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
-- AUTO_INCREMENT de la tabla `layers`
--
ALTER TABLE `layers`
  MODIFY `layerId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT de la tabla `mapas`
--
ALTER TABLE `mapas`
  MODIFY `mapaId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `tiles`
  MODIFY `tileId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=317;
--
-- AUTO_INCREMENT de la tabla `tilesets`
--
ALTER TABLE `tilesets`
  MODIFY `tilesetId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `tiles`
  ADD CONSTRAINT `tileCategoria` FOREIGN KEY (`idCategoria`) REFERENCES `categorias` (`categoriaId`) ON DELETE CASCADE ON UPDATE CASCADE,
